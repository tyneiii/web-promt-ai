...
<body>
    <div class="container">
        ...
        <div class="main">
            <?php
            $posts = [
                ['prompt_id' => 101, 'account_id' => 1, 'title' => 'Giải thích API đơn giản', 'status' => 'Waiting', 'created_' => '2025-10-01'],
                ['prompt_id' => 102, 'account_id' => 2, 'title' => 'Caption TikTok vui về học code', 'status' => 'Waiting', 'created_' => '2025-10-02'],
                ['prompt_id' => 103, 'account_id' => 1, 'title' => 'Blog 300 từ về động lực học lập trình', 'status' => 'Waiting', 'created_' => '2025-10-03'],
                ['prompt_id' => 104, 'account_id' => 3, 'title' => 'Poster game hành động nhân vật áo giáp', 'status' => 'Waiting', 'created_' => '2025-10-04'],
            ];
                            ...
                            <tbody>
                                <?php foreach ($filteredPosts as $index => $post): ?>
                                    <tr style="background-color: <?= $index % 2 === 0 ? '#ffffffff' : '#dcdbdbff' ?>;">
                                        ...
                                        <td style="text-transform: capitalize; color:blue; font-weight: bold;"><?= $post['status'] ?></td>
